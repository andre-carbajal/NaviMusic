...
- Update Java version from 21 to 25 across Dockerfile, CI workflow, and pom.xml
- Upgrade Spring Boot from 3.5.5 to 4.0.3
- Update JDA to 6.3.1, lavaplayer to 2.2.6, YouTube plugin to 1.18.0, and Spotify API to 9.4.0
